    ...
    if (this.userId) {
      ...
      if (this.isCurrentMonth()) {
        ...
        if (this.isFirstRegistration) {
          ...
          this.lunchRegistrationService
            .updateLunchRegistrationForNextMonth(this.userId, registrationDto)
            .subscribe(
              (response) => {
                console.log(
                  'Registration updated successfully for next month:',
                  response
                );
                this.toast.success(
                  'Registration updated successfully for next month!'
              ...
              (error) => {
                console.error(
                  'Error updating registration for next month:',
                  error
                );
                this.toast.error('Error updating registration for next month!');
              }
            );
        }
      }
